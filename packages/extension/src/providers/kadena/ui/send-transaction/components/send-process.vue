...
import SendProcessAccount from "@/ui/action/views/send-process/components/send-process-account.vue";
import SendProcessAmount from "@/ui/action/views/send-process/components/send-process-amount.vue";
